...
module input_system(
    ...
    // Internal wires
    wire [1:0] active_coeff_internal;
    wire signed [15:0] coeff_a_internal;
    wire signed [15:0] coeff_b_internal;
    wire signed [15:0] coeff_c_internal;
    wire sign_a_internal, sign_b_internal, sign_c_internal;
    ...
    coefficient_input coeff_in(
        ...
        .BTND(btnd_db),
        .function_type(function_type_top),
        .coeff_a(coeff_a_internal),
        .coeff_b(coeff_b_internal),
        .coeff_c(coeff_c_internal),
        .active_coeff(active_coeff_internal),
        ...
        .sign_a(sign_a_internal),
        .sign_b(sign_b_internal),
        .sign_c(sign_c_internal),
        .input_done(input_done_top)
    );
    
    // Sign toggle with sw[13]
    ...
    // Assign outputs
    assign active_coeff_top = active_coeff_internal;
    assign coeff_a_top = coeff_a_internal;
    assign coeff_b_top = coeff_b_internal;
    assign coeff_c_top = coeff_c_internal;
